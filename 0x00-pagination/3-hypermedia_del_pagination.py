...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """
        Get a hypermedia page of the dataset based on the given index and page
        size.

        Args:
            index (int, optional): The starting index of the page. Defaults to
            None.
        ...
        Returns:
            ...
            The dictionary has the following keys:
                ...
                - 'data' (list): A list of items from the dataset.
        """
        ...
        while len(data) < page_size and next_index < len(dataset):
            if dataset.get(next_index) is not None:
